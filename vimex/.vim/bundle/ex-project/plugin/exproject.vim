...
command! E call exproject#open_window()
command! EE call exproject#close_window()
...
call exproject#register_hotkey( 9  , 1, '<leader>f'       , ":EXProjectBuild<CR>"                                      , 'Rebuild project tree.' )
...
call exproject#register_hotkey( 13 , 1, '<leader>tt'      , ":EXProjectOpen<CR>"                                       , 'Open project tree.' )
call exproject#register_hotkey( 14 , 1, '<leader>tc'      , ":EXProjectClose<CR>"                                      , 'Close project tree.' )
