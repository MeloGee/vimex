...
if &t_Co >= 256
    let g:mycolors_term256=1
elseif !exists("g:mycolors_term256")
    let g:mycolors_term256=0
endif
fun! <sid>hi(group, fg, bg, attr, sp)
  if !empty(a:fg)
    exec "hi " . a:group . " guifg=" . a:fg.gui . " ctermfg=" . (g:mycolors_term256 ? a:fg.cterm256 : a:fg.cterm)
  endif
  if !empty(a:bg)
    exec "hi " . a:group . " guibg=" . a:bg.gui . " ctermbg=" . (g:mycolors_term256 ? a:bg.cterm256 : a:bg.cterm)
  endif
  if a:attr != ""
...
let s:cdCursorDarkDark = {'gui': '#222222', 'cterm': s:cterm01, 'cterm256': '237'}
...
let s:cdSearch = {'gui': '#4C4E50', 'cterm': s:cterm0A, 'cterm256': '202'}

" Syntax colors:

if !exists("g:mycolors_conservative")
    let g:mycolors_conservative=0
endif
...
if g:mycolors_conservative | let s:cdLightBlue = s:cdFront | endif
...
if g:mycolors_conservative | let s:cdLightRed = s:cdOrange | endif
let s:cdYellowOrange = {'gui': '#D7BA7D', 'cterm': s:cterm0A, 'cterm256': '179'}
let s:cdYellow = {'gui': '#DCDCAA', 'cterm': s:cterm0A, 'cterm256': '187'}
if g:mycolors_conservative | let s:cdYellow = s:cdFront | endif
let s:cdPink = {'gui': '#C586C0', 'cterm': s:cterm0E, 'cterm256': '176'}
if g:mycolors_conservative | let s:cdPink = s:cdBlue | endif
